"use strict";var _t=Object.create;var k=Object.defineProperty;var Et=Object.getOwnPropertyDescriptor;var gt=Object.getOwnPropertyNames;var Tt=Object.getPrototypeOf,ft=Object.prototype.hasOwnProperty;var St=(r,e)=>{for(var t in e)k(r,t,{get:e[t],enumerable:!0})},se=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of gt(e))!ft.call(r,n)&&n!==t&&k(r,n,{get:()=>e[n],enumerable:!(s=Et(e,n))||s.enumerable});return r};var L=(r,e,t)=>(t=r!=null?_t(Tt(r)):{},se(e||!r||!r.__esModule?k(t,"default",{value:r,enumerable:!0}):t,r)),bt=r=>se(k({},"__esModule",{value:!0}),r);var kt={};St(kt,{generateContext:()=>te});module.exports=bt(kt);var lt=L(require("path"),1),mt=require("os"),ut=require("fs");var _e=require("bun:sqlite");var b=require("path"),de=require("os"),pe=require("fs");var ce=require("url");var N=require("fs"),$=require("path"),oe=require("os");var re="bugfix,feature,refactor,discovery,decision,change",ne="how-it-works,why-it-exists,what-changed,problem-solution,gotcha,pattern,trade-off";var C=class{static DEFAULTS={MOLTBRAIN_MODEL:"claude-sonnet-4-5",MOLTBRAIN_CONTEXT_OBSERVATIONS:"50",MOLTBRAIN_WORKER_PORT:"37777",MOLTBRAIN_WORKER_HOST:"127.0.0.1",MOLTBRAIN_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",MOLTBRAIN_PROVIDER:"claude",MOLTBRAIN_GEMINI_API_KEY:"",MOLTBRAIN_GEMINI_MODEL:"gemini-2.5-flash-lite",MOLTBRAIN_GEMINI_RATE_LIMITING_ENABLED:"true",MOLTBRAIN_OPENROUTER_API_KEY:"",MOLTBRAIN_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",MOLTBRAIN_OPENROUTER_SITE_URL:"",MOLTBRAIN_OPENROUTER_APP_NAME:"moltbrain",MOLTBRAIN_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",MOLTBRAIN_OPENROUTER_MAX_TOKENS:"100000",MOLTBRAIN_DATA_DIR:(0,$.join)((0,oe.homedir)(),".moltbrain"),MOLTBRAIN_LOG_LEVEL:"INFO",MOLTBRAIN_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",MOLTBRAIN_MODE:"code",MOLTBRAIN_CONTEXT_SHOW_READ_TOKENS:"true",MOLTBRAIN_CONTEXT_SHOW_WORK_TOKENS:"true",MOLTBRAIN_CONTEXT_SHOW_SAVINGS_AMOUNT:"true",MOLTBRAIN_CONTEXT_SHOW_SAVINGS_PERCENT:"true",MOLTBRAIN_CONTEXT_OBSERVATION_TYPES:re,MOLTBRAIN_CONTEXT_OBSERVATION_CONCEPTS:ne,MOLTBRAIN_CONTEXT_FULL_COUNT:"5",MOLTBRAIN_CONTEXT_FULL_FIELD:"narrative",MOLTBRAIN_CONTEXT_SESSION_COUNT:"10",MOLTBRAIN_CONTEXT_SHOW_LAST_SUMMARY:"true",MOLTBRAIN_CONTEXT_SHOW_LAST_MESSAGE:"false"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){return this.get(e)==="true"}static loadFromFile(e){try{if(!(0,N.existsSync)(e)){let i=this.getAllDefaults();try{let a=(0,$.dirname)(e);(0,N.existsSync)(a)||(0,N.mkdirSync)(a,{recursive:!0}),(0,N.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.log("[SETTINGS] Created settings file with defaults:",e)}catch(a){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,a)}return i}let t=(0,N.readFileSync)(e,"utf-8"),s=JSON.parse(t),n=s;if(s.env&&typeof s.env=="object"){n=s.env;try{(0,N.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),console.log("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(i){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,i)}}let o={...this.DEFAULTS};for(let i of Object.keys(this.DEFAULTS))n[i]!==void 0&&(o[i]=n[i]);return o}catch(t){return console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t),this.getAllDefaults()}}};var y=require("fs"),v=require("path"),ae=require("os"),G=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(G||{}),ie=(0,v.join)((0,ae.homedir)(),".claude-recall"),H=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(ie,"logs");(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-recall-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(ie,"settings.json");if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_RECALL_LOG_LEVEL||"INFO").toUpperCase();this.level=G[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):m=" "+this.formatData(o));let u="";if(n){let{sessionId:E,memorySessionId:T,correlationId:h,..._}=n;Object.keys(_).length>0&&(u=` {${Object.entries(_).map(([f,R])=>`${f}=${R}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${c}${s}${u}${m}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",u={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},l=new H;var Rt={};function ht(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,ce.fileURLToPath)(Rt.url))}var Ot=ht(),I=C.get("MOLTBRAIN_DATA_DIR"),W=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,de.homedir)(),".claude"),Ht=(0,b.join)(I,"archives"),Wt=(0,b.join)(I,"logs"),Yt=(0,b.join)(I,"trash"),Vt=(0,b.join)(I,"backups"),qt=(0,b.join)(I,"modes"),Kt=(0,b.join)(I,"settings.json"),le=(0,b.join)(I,"moltbrain.db"),Jt=(0,b.join)(I,"vector-db"),zt=(0,b.join)(W,"settings.json"),Qt=(0,b.join)(W,"commands"),Zt=(0,b.join)(W,"CLAUDE.md");function me(r){(0,pe.mkdirSync)(r,{recursive:!0})}function ue(){return(0,b.join)(Ot,"..")}var w=class{db;constructor(e=le){e!==":memory:"&&me(I),this.db=new _e.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn()}initializeSchema(){this.db.run(`
    ...
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),m=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let d=a??Date.now(),c=new Date(d).toISOString();return this.db.transaction(()=>{let u=[],g=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let T of s){let h=g.run(e,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),o||null,i,c,d);u.push(Number(h.lastInsertRowid))}let E=null;if(n){let h=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let S of s){let f=T.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),a||null,d,u,m);E.push(Number(f.lastInsertRowid))}let h;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  ...
  `).all(...e,...s,...o,t.totalObservationCount)}function Re(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,t.sessionCount+V)}function It(r){return r.replace(/\//g,"-")}function yt(r){try{if(!(0,F.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,F.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
...
`}function et(r,e,t,s){let n=[];return s?n.push(...je(r)):n.push(...Ce(r)),s?n.push(...Xe()):n.push(...Ae()),s?n.push(...Ge()):n.push(...Le()),s?n.push(...He()):n.push(...ve()),P(t)&&(s?n.push(...We(e,t)):n.push(...Me(e,t))),n}var ee=L(require("path"),1);function X(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return l.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function st(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function rt(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function nt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function tt(r,e){return ee.default.isAbsolute(r)?ee.default.relative(e,r):r}function ot(r,e,t){let s=X(r);if(s.length>0)return tt(s[0],e);if(t){let n=X(t);if(n.length>0)return tt(n[0],e)}return"General"}function Ct(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=nt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function At(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?X(r.facts).join(`
`):null}function Lt(r,e,t,s,n,o){let i=[];o?i.push(...Ye(r)):i.push(...De(r));let a=null,d="",c=!1;for(let m of e)if(m.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let u=m.data,g=st(u.displayTime);o?i.push(...Je(u,g)):i.push(...we(u,g))}else{let u=m.data,g=ot(u.files_modified,n,u.files_read),E=rt(u.created_at),T=E!==d,h=T?E:"";d=E;let _=t.has(u.id);if(g!==a&&(c&&i.push(""),o?i.push(...Ve(g)):i.push(...xe(g)),a=g,c=!0),_){let S=At(u,s);o?i.push(...Ke(u,E,T,S,s)):(c&&!o&&(i.push(""),c=!1),i.push(...$e(u,h,S,s)),a=null)}else o?i.push(qe(u,E,T,s)):i.push(ke(u,h,s))}return c&&i.push(""),i}function it(r,e,t,s,n){let o=[],i=Ct(r);for(let[a,d]of i)o.push(...Lt(a,d,e,t,s,n));return o}function at(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function dt(r,e){let t=[];return e?(t.push(...x("Investigated",r.investigated,p.blue)),t.push(...x("Learned",r.learned,p.yellow)),t.push(...x("Completed",r.completed,p.green)),t.push(...x("Next Steps",r.next_steps,p.magenta))):(t.push(...D("Investigated",r.investigated)),t.push(...D("Learned",r.learned)),t.push(...D("Completed",r.completed)),t.push(...D("Next Steps",r.next_steps))),t}function pt(r,e){return e?ze(r):Ue(r)}function ct(r,e,t){return!P(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Qe(r.totalDiscoveryTokens,r.totalReadTokens):Pe(r.totalDiscoveryTokens,r.totalReadTokens)}var vt=lt.default.join((0,mt.homedir)(),".claude","plugins","marketplaces","nhevers","plugin",".install-version");function Mt(){try{return new w}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,ut.unlinkSync)(vt)}catch(e){l.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return l.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Dt(r,e){return e?Ze(r):Fe(r)}function xt(r,e,t,s,n,o,i){let a=[],d=K(e);a.push(...et(r,d,s,i));let c=t.slice(0,s.sessionCount),m=Ne(c,t),u=Z(e,m),g=Ie(e,s.fullObservationCount);a.push(...it(u,g,s,n,i));let E=t[0],T=e[0];at(s,E,T)&&a.push(...dt(E,i));let h=Q(e,s,o,n);return a.push(...pt(h,i)),a.push(...ct(d,s,i)),a.join(`
